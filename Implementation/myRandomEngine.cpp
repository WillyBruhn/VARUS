...
//U32 myRandomEngine::select_randomly(UDmap::iterator begin, UDmap::iterator end){
//	std::discrete_distribution<> d(begin,end);
//	return d(gen);
//}
...
//void myRandomEngine::shuffle(std::vector<int> &vec){
